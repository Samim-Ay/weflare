...
const links = [
  { title: "Kontaktieren", href: "/contact" },
  ...
  return (
    <footer className="py-16 md:py-32">
      <div className="mx-auto max-w-5xl px-6">
        <Link href="/" aria-label="Zur Startseite" className="mx-auto block size-fit">
          <Logo />
        </Link>
        ...
        <span className="text-muted-foreground block text-center text-sm">
          {" "}
          © {new Date().getFullYear()} Weflare, Alle Rechte vorbehalten
        </span>
      </div>
    </footer>
  );
